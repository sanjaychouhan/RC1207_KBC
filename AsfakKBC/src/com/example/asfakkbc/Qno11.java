...
public class Qno11 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno11);
		
		mediaPlayer = MediaPlayer.create(this, R.raw.elevn);
		mediaPlayer.start();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno11, menu);
		return true;
	}
	...
	public void aClick(View view){
		  if(a==1){
			  ValueAnimator colorAnim = ObjectAnimator.ofInt(t1, "backgroundColor", RED, BLUE);
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno11.this,Level11.class);
	                    startActivity(i);
	                }
	            }, 2000);
	    ...
	    public void bClick(View view){
	    	 if(a==0)
	 	    	((EditText) t2).setBackgroundColor(0xFF00FF7F);
	 	        	...
	 	        	Intent intent = new Intent(this, Pricen.class);
