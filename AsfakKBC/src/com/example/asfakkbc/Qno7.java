...
public class Qno7 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno7);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno7, menu);
		return true;
	}
		 ...
		 if(a==1){
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno7.this,Level7.class);
	                    startActivity(i);
	                }
	            }, 2000);
	    ...
	    public void bClick(View view){
	    	if(a==0)
		    	((EditText) t2).setBackgroundColor(0xFF00FF7F);
		        	...
		        	Intent intent = new Intent(this, Price6.class);
