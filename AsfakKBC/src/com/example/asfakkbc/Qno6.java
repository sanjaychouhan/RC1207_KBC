...
public class Qno6 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno6);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno6, menu);
		return true;
	}
	 ...
	 public void aClick(View view){
	    	...
	    	((EditText) t1).setBackgroundColor(0xFF00FF7F);
	        	...
	        	Intent intent = new Intent(this, Price5.class);
	    	...
	    	if(a==1){
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno6.this,Level6.class);
	                    startActivity(i);
	                }
	            }, 2000);
