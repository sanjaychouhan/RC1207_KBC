...
public class Qno13 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno13);
		
		mediaPlayer = MediaPlayer.create(this, R.raw.thrtn);
		mediaPlayer.start();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno13, menu);
		return true;
	}
	...
	public void aClick(View view){
		...
		startActivity(intent);
        	...
        	Intent intent = new Intent(this, Price11.class);
    		startActivity(intent);
    	}
    }
    	...
    	if(a==1){
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent i=new Intent(Qno13.this,Level12.class);
                    startActivity(i);
                }
            }, 2000);
