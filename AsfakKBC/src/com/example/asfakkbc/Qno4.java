...
public class Qno4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno4);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno4, menu);
		return true;
	}
			 ...
			 ValueAnimator colorAnim = ObjectAnimator.ofInt(t1, "backgroundColor", RED, BLUE);
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno4.this,Level4.class);
	                    startActivity(i);
	                }
	            }, 2000);
	    ...
	    public void bClick(View view){
	    	if(a==0)
		    	((EditText) t2).setBackgroundColor(0xFF00FF7F);
		        	...
		        	Intent intent = new Intent(this, Price3.class);
		    		startActivity(intent);
		    	}
	    }
