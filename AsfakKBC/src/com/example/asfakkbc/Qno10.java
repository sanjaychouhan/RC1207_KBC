...
public class Qno10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno10);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno10, menu);
		return true;
	}
	...
	public void aClick(View view){
		if(a==0)
	    	((EditText) t1).setBackgroundColor(0xFF00FF7F);
	        	...
	        	Intent intent = new Intent(this, Price9.class);
		...
		public void dClick(View view){
	    	...
	    	if(a==1){
	    		ValueAnimator colorAnim = ObjectAnimator.ofInt(t4, "backgroundColor", RED, BLUE);
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno10.this,Level10.class);
	                    startActivity(i);
	                }
	            }, 2000);
