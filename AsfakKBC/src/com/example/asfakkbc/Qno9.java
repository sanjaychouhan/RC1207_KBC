...
public class Qno9 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno9);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno9, menu);
		return true;
	}
    ...
    public void aClick(View view){
    	...
    	((EditText) t1).setBackgroundColor(0xFF00FF7F);
        	...
        	Intent intent = new Intent(this, Price8.class);
    	...
    	if(a==1){
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent i=new Intent(Qno9.this,Level9.class);
                    startActivity(i);
                }
            }, 2000);
