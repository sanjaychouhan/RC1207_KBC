...
public class Qno2 extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno2, menu);
		return true;
	}
	 ...
	 public void aClick(View view){
	    	...
	    	Intent intent = new Intent(this, Price0.class);
	    	...
	    	if(a==1){
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno2.this,Level2.class);
	                    startActivity(i);
	                }
	            }, 2000);
