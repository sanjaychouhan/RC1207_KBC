...
public class Qno12 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno12);
		
		mediaPlayer = MediaPlayer.create(this, R.raw.twlw);
		mediaPlayer.start();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno12, menu);
		return true;
	}
	 ...
	 public void aClick(View view){
			...
			startActivity(intent);
	        	...
	        	Intent intent = new Intent(this, Price10.class);
	    		startActivity(intent);
	    	}
	    }
	    	...
	    	if(a==1){
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno12.this,Level13.class);
	                    startActivity(i);
	                }
	            }, 2000);
