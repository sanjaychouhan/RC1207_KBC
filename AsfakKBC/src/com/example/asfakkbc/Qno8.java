...
public class Qno8 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno8);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno8, menu);
		return true;
	}
 ...
 public void aClick(View view){
		if(a==0)
	    	((EditText) t1).setBackgroundColor(0xFF00FF7F);
	        	...
	        	Intent intent = new Intent(this, Price7.class);
	    	...
	    	if(a==1){
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno8.this,Level8.class);
	                    startActivity(i);
	                }
	            }, 2000);
