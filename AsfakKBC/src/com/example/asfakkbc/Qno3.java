...
public class Qno3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qno3);
		
		mediaPlayer = MediaPlayer.create(this, R.raw.three);
		mediaPlayer.start();
		mediaPlayer.setLooping(false);
		
		mp = MediaPlayer.create(this, R.raw.aawa);
		mp.start();
		mp.setLooping(false);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.qno3, menu);
		return true;
	}
	 ...
	 public void aClick(View view){
	    	...
	    	Intent intent = new Intent(this, Price2.class);
	    	...
	    	if(a==1){
	            ...
	            new Handler().postDelayed(new Runnable() {
	                ...
	                public void run() {
	                    ...
	                    Intent i=new Intent(Qno3.this,Level3.class);
	                    startActivity(i);
	                }
	            }, 2000);
